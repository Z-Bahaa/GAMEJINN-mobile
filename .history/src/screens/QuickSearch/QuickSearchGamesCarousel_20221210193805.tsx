...
const QuickSearchGamesCarousel = ({}) => {
  ...
  return (
    <Box  style={styles.container} dataSet={{ media: ids.container}} >
      ...
      >
        {gamesList.map((g: any) => (<VStack  style={styles.item} dataSet={{ media: ids.item}} >
          <Image alt="game image" source= {{uri : gimageUrl}}    style={styles.image} dataSet={{ media: ids.image}}   />
