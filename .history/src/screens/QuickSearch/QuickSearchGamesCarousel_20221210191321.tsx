...
const QuickSearchGamesCarousel = ({}) => {
  ...
  return (
    <Box  style={styles.container} dataSet={{ media: ids.container}} >
      <VStack>
        <Image alt="game image" source= {{uri : "https://cdn.shopify.com/s/files/1/0747/3829/products/mL4468_1024x1024.jpg?v=1591827160"}}    style={styles.image} dataSet={{ media: ids.container}}   />
