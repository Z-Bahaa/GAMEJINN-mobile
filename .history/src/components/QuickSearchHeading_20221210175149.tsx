...
const QuickSearchHeading = ({primaryText,}) => {
  ...
  return (
    <HStack  style={styles.container} dataSet={{ media: ids.container}} >
      ...
      <Button variant="unstyled" p={0} style={styles.Button} dataSet={{ media: ids.primaButtonryText}} >
        <Text style={styles.primaryText} dataSet={{ media: ids.primaryText}} >view all</Text>
